...
def data_preprocessing(dataset,savefile=None):
    ...
    dataPath = os.path.join('python/data',dataset)
    ...
    if savefile==None:
        ...
        new_df.to_csv(os.path.join('python/data',savefile))
    ...
    if savefile==None:
        ...
        playlistDF_test=pd.read_csv(os.path.join('python/data',savefile))
    playlistDF_test=playlist_preprocesses(playlistDF_test)
    playlistDF_test.to_csv(os.path.join('python/data',savefile))